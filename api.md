...
| 국토교통부_교통CCTV (`LT_P_UTISCCTV`) | 영상 보안 관제 CCTV 위치 실데이터 수집 (`traffic-cctv-markers`) | 사용 중 | `TEAM2_DIGITAL_TWIN_API_KEY`, `TEAM2_DIGITAL_TWIN_API_DOMAIN` | VWorld Data API 2.0 `GetFeature` (`/api/cctv/positions`) | 2026-03-03 |
