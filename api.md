...
| 국토교통부_비행금지구역 (`LT_C_AISPRHC`) | 항공/공역 관제 비행금지구역 실데이터 수집 (`no-fly-zones`) | 사용 중 | `TEAM2_AVIATION_NO_FLY_API_KEY`, `TEAM2_AVIATION_NO_FLY_API_DOMAIN` | VWorld Data API 2.0 `GetFeature` (`/api/aviation/no-fly`) | 2026-03-03 |
